...
class DataTransformation:
  ...
  def get_data_transformer_object(self):
    ...
    try:
      ...
      logging.info(f"Categorical columns {categorical_columms}")

      preprocessor = ColumnTransformer(
        [
          ("num_pipeline",num_pipeline,numerical_columns),
          ("cat_pipeline",cat_pipeline,categorical_columms)
        ]
      )
  ...
  def initiate_data_trsnformation(self,train_path,test_path):
    try:
